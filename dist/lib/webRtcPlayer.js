'use strict'; // Copyright 1998-2018 Epic Games, Inc. All Rights Reserved.
...
(function (root, factory) {
  ...
  function webRtcPlayer(parOptions) {
    ...
    var createWebRtcVideo = function createWebRtcVideo() {
    ...
    var setupDataChannel = function setupDataChannel(pc, label, options) {
      try {
        var datachannel = pc.createDataChannel(label, options);
        console.log("Created datachannel (".concat(label, ")"));

        datachannel.onopen = function (e) {
          console.log("data channel (".concat(label, ") connect"));
        ...
        datachannel.onclose = function (e) {
          console.log("data channel (".concat(label, ") closed"));
        };

        datachannel.onmessage = function (e) {
          console.log("Got message (".concat(label, ")"), e.data);
    ...
    var setupPeerConnection = function setupPeerConnection(pc) {
      if (pc.SetBitrate) console.log("Hurray! there's RTCPeerConnection.SetBitrate function"); //Setup peerConnection events
    ...
    this.handleCandidateFromServer = function (iceCandidate) {
      ...
      self.pcClient.addIceCandidate(candidate).then(function (_) {
